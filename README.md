...
(C) 2025 堀江 健 / Copyright all rights reserved
...
本ソフトウェアはGNU一般公衆利用許諾契約書バージョン3に基づき以下の表示をしています。(本ソフトウェアを使用して不具合が生じた場合、此方側は責任を負いかねませんが、今後の品質改善更新は通常通り行います。又、ソースコード内に別のライセンスに関する記述が無い場合、以下の表示が適用されたとして扱います。更に、本ソフトウェアは基と為っているソフトウェアのソースとの乖離が非常に大きい為、総ての部分が改変されたとして扱います。)
